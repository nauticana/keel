...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
     WHERE constraint_name = 'subs_plan_invoice_lines' AND table_name = 'subscription_invoice_line'
  ) THEN
    ALTER TABLE subscription_invoice_line ADD CONSTRAINT subs_plan_invoice_lines FOREIGN KEY (plan_id) REFERENCES subscription_plan(id);
  END IF;
END $$;
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
     WHERE constraint_name = 'subs_addon_invoice_lines' AND table_name = 'subscription_invoice_line'
  ) THEN
    ALTER TABLE subscription_invoice_line ADD CONSTRAINT subs_addon_invoice_lines FOREIGN KEY (addon_id) REFERENCES subscription_addon(id);
  END IF;
END $$;
DO $$
BEGIN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
     WHERE constraint_name = 'agency_client_invitations' AND table_name = 'agency_client_invitation'
  ) THEN
    ALTER TABLE agency_client_invitation ADD CONSTRAINT agency_client_invitations FOREIGN KEY (agency_partner_id) REFERENCES agency_profile(agency_partner_id) ON DELETE CASCADE;
  END IF;
END $$;
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
     WHERE constraint_name = 'agency_invitations_client' AND table_name = 'agency_client_invitation'
  ) THEN
    ALTER TABLE agency_client_invitation ADD CONSTRAINT agency_invitations_client FOREIGN KEY (client_partner_id) REFERENCES business_partner(id) ON DELETE SET NULL;
  END IF;
END $$;
DO $$
BEGIN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
     WHERE constraint_name = 'agencies_payout_profile' AND table_name = 'agency_payout_profile'
  ) THEN
    ALTER TABLE agency_payout_profile ADD CONSTRAINT agencies_payout_profile FOREIGN KEY (agency_partner_id) REFERENCES agency_profile(agency_partner_id) ON DELETE CASCADE;
  END IF;
END $$;
DO $$
BEGIN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
     WHERE constraint_name = 'agency_client_rates' AND table_name = 'agency_client_rate'
  ) THEN
    ALTER TABLE agency_client_rate ADD CONSTRAINT agency_client_rates FOREIGN KEY (agency_partner_id) REFERENCES agency_profile(agency_partner_id) ON DELETE CASCADE;
  END IF;
END $$;
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
     WHERE constraint_name = 'agency_rates_client' AND table_name = 'agency_client_rate'
  ) THEN
    ALTER TABLE agency_client_rate ADD CONSTRAINT agency_rates_client FOREIGN KEY (client_partner_id) REFERENCES business_partner(id) ON DELETE CASCADE;
  END IF;
END $$;
DO $$
BEGIN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
     WHERE constraint_name = 'agency_payouts' AND table_name = 'agency_payout'
  ) THEN
    ALTER TABLE agency_payout ADD CONSTRAINT agency_payouts FOREIGN KEY (agency_partner_id) REFERENCES agency_profile(agency_partner_id);
  END IF;
END $$;
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
     WHERE constraint_name = 'payout_destination_account' AND table_name = 'agency_payout'
  ) THEN
    ALTER TABLE agency_payout ADD CONSTRAINT payout_destination_account FOREIGN KEY (user_bank_info_id, agency_partner_id) REFERENCES user_bank_info(id, partner_id);
  END IF;
END $$;
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
     WHERE constraint_name = 'agency_payout_lines' AND table_name = 'agency_payout_line'
  ) THEN
    ALTER TABLE agency_payout_line ADD CONSTRAINT agency_payout_lines FOREIGN KEY (payout_id) REFERENCES agency_payout(id);
  END IF;
END $$;
DO $$
BEGIN
