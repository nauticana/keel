...
func (d *MySQL) GenerateSchema(s *schema.Schema) string {
	...
	sb.WriteString("-- Runtime note: agency commission/provenance services currently require PostgreSQL.\n")
	sb.WriteString("-- Agency tables are emitted here for schema portability only.\n")
	sb.WriteString("-- ==========================================================================\n\n")
